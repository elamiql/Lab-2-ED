...
int main() {
    ...
    cout << "Tamaño inicial del árbol: " << libroTree.size() << " libros."
         << endl
         << endl;

    cout << "--- EJECUTANDO CONSULTA: listar() ---" << endl;
    vector<string> listaPreorder = libroTree.listar();
    cout << "Total de IDs recuperados en PreOrder: " << listaPreorder.size()
         << endl;
    ...
    cout << "Cantidad de libros que son precursores de sus similares: "
         << listaPrecursores.size() << endl;
    ...
    cout << "--- EJECUTANDO CONSULTA: borrar_ratings(" << filtroRating
         << ") ---" << endl;
    libroTree.borrar_ratings(filtroRating);
    cout << "Tamaño del árbol después del borrado masivo: " << libroTree.size()
         << " libros." << endl;

    vector<string> listaPostBorrado = libroTree.listar();
    cout << "Nuevo total de IDs en el árbol: " << listaPostBorrado.size()
         << endl;
